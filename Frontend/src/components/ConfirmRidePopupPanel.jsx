            ...
            <div className="flex gap-2 flex-col items-center justify-between ">
                ...
                <div className="mt-6 w-full">
                    <form onSubmit={submitHander}>
                        <input value={otp}  className="bg-[#eee] px-6 py-4 font-mono text-base rounded-lg w-full mt-3" 
                        onChange={(e)=>{
                        ...
                        <button
                            ...
                            className="w-full mt-2  text-white bg-red-600 text-lg font-semibold p-3 rounded-lg"
                        >
                            Cancel
                        </button>
                    </form>
